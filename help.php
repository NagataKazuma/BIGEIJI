...
<!-- ページ上部のリスト -->
<ul id="menu">
<li><a href="http://localhost/sotuken/top.php?movie_title"><div class="title-font"><img src="img/icon.png"> Canelé Films</div></a></li>
...
<div class = top_text>
<h1>お問い合わせフォーム</h1><br />
※下記フォームに必要事項を記入の上送信してください。<br /><br /><br />
...
<br />
お問い合わせ内容<br /></div>
<input type="text" name="toiawasetxt" style="width:700px;height:200px;font-size:1em;"><br /><br />
