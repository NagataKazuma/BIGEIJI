...
<body>
    <div class="wrapper">
        ...
        <div class="container">
            <!-- トップテキスト -->
            <div class=top_text>上映予定の映画β</div>
            <div class=sub_text><a href="nowplay.php">
                    上映中の映画はこちら</a>
            </div>
            <!-- TMDBapiを投げてレスポンスを描写 -->
            <?php
            ...
            $juni = '位:';
            // toplistのURLにjsonを要求
            $top_list = file_get_contents("https://api.themoviedb.org/3/movie/upcoming?api_key=" . $apikey . "&language=ja&page=1&region=JP");
            $movieTop = json_decode($top_list, true);
            $top_list2 = file_get_contents("https://api.themoviedb.org/3/movie/upcoming?api_key=" . $apikey . "&language=ja&page=2&region=JP");
